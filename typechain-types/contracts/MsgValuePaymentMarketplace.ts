...
export interface MsgValuePaymentMarketplaceInterface extends utils.Interface {
  functions: {
...
export interface MsgValuePaymentMarketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MsgValuePaymentMarketplaceInterface;
