...
export interface IErc20PaymentMarketplaceInterface extends utils.Interface {
  functions: {
    ...
    "makeOffer(address,uint256,uint256,uint64)": FunctionFragment;
...
export interface IErc20PaymentMarketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IErc20PaymentMarketplaceInterface;
