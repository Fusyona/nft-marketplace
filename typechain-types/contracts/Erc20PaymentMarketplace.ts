...
export interface Erc20PaymentMarketplaceInterface extends utils.Interface {
  functions: {
...
export interface Erc20PaymentMarketplace extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Erc20PaymentMarketplaceInterface;
