...
interface IMarketplace {
    ...
    function cancelOffer(address collectiom, uint256 tokenId, uint256 indexOfOfferMapping) external;

    function setFeeRatio(int128 _percentageMultipliedBy2Up64AndTwoDecimals) external;
